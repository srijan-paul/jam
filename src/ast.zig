...
pub const Node = union(enum) {
    ...
    optional_expr: PropertyAccess,
    computed_optional_expr: ComputedPropertyAccess,
    arguments: ?Arguments,
    new_expr: CallExpr,
    call_expr: CallExpr,
    optional_call_expr: CallExpr,
...
pub const NodePretty = union(enum) {
    ...
    optional_computed_expression: ComputedPropertyAccess_,
    optional_expression: PropertyAccess_,
    arguments: Pretty(Arguments),
    new_expression: Pretty(CallExpr),
    call_expression: Pretty(CallExpr),
    optional_call_expression: Pretty(CallExpr),
